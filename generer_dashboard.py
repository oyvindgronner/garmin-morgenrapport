...
def main():
    ...
    passord    = os.environ.get("DASHBOARD_PASSWORD") or "hamburg26"
...
.site-header-right{{font-size:0.75rem;color:rgba(255,255,255,.7);text-align:right;display:flex;align-items:center;gap:12px}}
.logg-ut-btn{{background:transparent;border:1px solid rgba(255,255,255,.3);color:rgba(255,255,255,.65);border-radius:3px;padding:4px 10px;font-size:0.7rem;cursor:pointer;font-family:inherit;letter-spacing:.04em;text-transform:uppercase;transition:border-color .2s,color .2s}}
.logg-ut-btn:hover{{border-color:rgba(255,255,255,.7);color:#fff}}
...
<div id="dash">
  <div class="site-header">
    ...
    <div class="site-header-right">
      <span>Øyvind Grønner &nbsp;·&nbsp; Sub 3:00</span>
      <button class="logg-ut-btn" onclick="loggUt()">Logg ut</button>
    </div>
  </div>
  <div class="topbar">
